...
/**************************************************************************/
/**
 * Main event loop for VPNConnect.in UDP server mode.
 * @ingroup eventloop
 *
 * This function implements VPNConnect.s main event loop for UDP server mode.
 *  At this time, VPNConnect.does not yet support multithreading.  This
