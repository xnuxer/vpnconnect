 ...
 * setup to determine whether the remote VPNConnect.peer's certificate is
 ...
 * VPNConnect.specific verification.
 *
 * @param preverify_ok - Whether the remote VPNConnect.peer's certificate
