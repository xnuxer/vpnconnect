 ...
 * negotiation between VPNConnect.peers.  VPNConnect.servers and clients
...
#define S_PRE_START       2     /**< Waiting for the remote VPNConnect.peer
                                 *   to acknowledge during the initial
                                 *   three-way handshake. */
#define S_START           3     /**< Three-way handshake is complete,
                                 *   start of key exchange. */
#define S_SENT_KEY        4     /**< Local VPNConnect.process has sent its
                                 *   part of the key material. */
#define S_GOT_KEY         5     /**< Local VPNConnect.process has received
 ...
 * VPNConnect.peers.  It includes the control channel TLS state and the data
...
struct tls_options
{
  ...
  /* allow vpnconnect config info to be
 ...
 * @ingroup control_processor
 *
 * This structure represents an VPNConnect.peer-to-peer control channel
 * session.
 *
 ...
 *
 *  Normally three tls_session objects are maintained by an active vpnconnect
