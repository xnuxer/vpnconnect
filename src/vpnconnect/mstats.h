 ...
 *             packet compression.
 *
 *  Copyright (C) 2002-2011 VPNConnect.Technologies, Inc. <sale@vpnconnect.net>
...
#if !defined(VPNCONNECT_MEMSTATS_H) && defined(ENABLE_MEMSTATS)
#define VPNCONNECT_MEMSTATS_H
