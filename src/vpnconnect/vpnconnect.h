...
/**************************************************************************/
/**
 * Level 0 %context containing information related to the VPNConnect.process.
 *
 * Level 0 state is initialized once at program startup, and then remains
 * throughout the lifetime of the VPNConnect.process.  This structure
...
struct context_1
{
  ...
  struct md5_digest pulled_options_digest_save;
                                 ...
                                 *   remote VPNConnect.server.  Only used in
                                 *   client-mode. */
...
# define FILE_CLOSED       (1<<8)
  ...
  /* Timer for everything up to the first packet from the *VPNConnect. server
...
# define CM_CHILD_TCP      4 /* child context of a CM_TOP or CM_THREAD */
  int mode;                     /**< Role of this context within the
                                 *   VPNConnect.process.  Valid values are \c
