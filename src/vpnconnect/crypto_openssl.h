...
#define VPNCONNECT_MAX_IV_LENGTH 	EVP_MAX_IV_LENGTH

/** Cipher is in CBC mode */
#define VPNCONNECT_MODE_CBC 	EVP_CIPH_CBC_MODE

/** Cipher is in OFB mode */
#define VPNCONNECT_MODE_OFB	EVP_CIPH_OFB_MODE

/** Cipher is in CFB mode */
#define VPNCONNECT_MODE_CFB 	EVP_CIPH_CFB_MODE

#ifdef HAVE_AEAD_CIPHER_MODES

/** Cipher is in GCM mode */
#define VPNCONNECT_MODE_GCM 	EVP_CIPH_GCM_MODE

#endif /* HAVE_AEAD_CIPHER_MODES */

/** Cipher should encrypt */
#define VPNCONNECT_OP_ENCRYPT 	1

/** Cipher should decrypt */
#define VPNCONNECT_OP_DECRYPT 	0
