...
#ifndef VPNCONNECT_SSL_H
#define VPNCONNECT_SSL_H
...
#define KEY_EXPANSION_ID "VPNConnect"
...
/**
 * Build master SSL context object that serves for the whole o. VPNConnect
 * instantiation
 */
 ...
 *
 * When VPNConnect.is in TLS mode, this is the first function to process an
 ...
 * options so that \p vpnconnect_decrypt() can later use them to authenticate
 ...
 * valid initial packet.  It is only used when VPNConnect.is running in
 * server mode.
 *
...
/**
 * Prepend a one-byte VPNConnect.data channel P_DATA_V1 opcode to the packet.
 *
...
/**
 * Prepend an VPNConnect.data channel P_DATA_V2 header to the packet.  The
