...
#ifndef VPNCONNECT_PLUGIN_H
#define VPNCONNECT_PLUGIN_H
...
struct plugin {
  ...
  vpnconnect_plugin_open_v1 open1;
  vpnconnect_plugin_open_v2 open2;
  vpnconnect_plugin_open_v3 open3;
  vpnconnect_plugin_func_v1 func1;
  vpnconnect_plugin_func_v2 func2;
  vpnconnect_plugin_func_v3 func3;
  vpnconnect_plugin_close_v1 close;
  vpnconnect_plugin_abort_v1 abort;
  vpnconnect_plugin_client_constructor_v1 client_constructor;
  vpnconnect_plugin_client_destructor_v1 client_destructor;
  vpnconnect_plugin_min_version_required_v1 min_version_required;
  vpnconnect_plugin_select_initialization_point_v1 initialization_point;

  vpnconnect_plugin_handle_t plugin_handle;
};
...
{
  int n;
  struct vpnconnect_plugin_string_list *list[MAX_PLUGINS];
};
