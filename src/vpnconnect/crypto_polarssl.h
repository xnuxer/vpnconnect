...
#define VPNCONNECT_MAX_IV_LENGTH 	POLARSSL_MAX_IV_LENGTH

/** Cipher is in CBC mode */
#define VPNCONNECT_MODE_CBC 	POLARSSL_MODE_CBC

/** Cipher is in OFB mode */
#define VPNCONNECT_MODE_OFB 	POLARSSL_MODE_OFB

/** Cipher is in CFB mode */
#define VPNCONNECT_MODE_CFB 	POLARSSL_MODE_CFB

/** Cipher is in GCM mode */
#define VPNCONNECT_MODE_GCM	POLARSSL_MODE_GCM

/** Cipher should encrypt */
#define VPNCONNECT_OP_ENCRYPT 	POLARSSL_ENCRYPT

/** Cipher should decrypt */
#define VPNCONNECT_OP_DECRYPT 	POLARSSL_DECRYPT
