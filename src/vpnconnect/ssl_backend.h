 ...
 * Called on VPNConnect.initialisation
 */
void tls_init_lib();
...
/** @name Functions for packets to be sent to a remote VPNConnect.peer
 *  @{ */
...
/** @name Functions for packets received from a remote VPNConnect.peer
 *  @{ */
