...
typedef enum {
  ...
  interactive,
  _service_max
} vpnconnect_service_type;

typedef struct {
  vpnconnect_service_type type;
  TCHAR *name;
  TCHAR *display_name;
  TCHAR *dependencies;
  DWORD start_type;
} vpnconnect_service_t;
...
extern vpnconnect_service_t automatic_service;
extern vpnconnect_service_t interactive_service;


VOID WINAPI ServiceStartAutomatic (DWORD argc, LPTSTR *argv);
VOID WINAPI ServiceStartInteractive (DWORD argc, LPTSTR *argv);

int vpnconnect_vsntprintf (LPTSTR str, size_t size, LPCTSTR format, va_list arglist);
int vpnconnect_sntprintf (LPTSTR str, size_t size, LPCTSTR format, ...);
