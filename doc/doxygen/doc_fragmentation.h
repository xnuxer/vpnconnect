 ...
 * data channel large packet to be sent to a remote VPNConnect.peer can be
 ...
 * - For packets which will be sent to a remote VPNConnect.peer: \c
 *   fragment_outgoing() \n This function inspects data channel packets as
 *   they are being made ready to be sent as VPN tunnel packets to a
 *   remote VPNConnect.peer.  If a packet's size is larger than its
 ...
 * - For packets which have been received from a remote VPNConnect.peer: \c
 *   fragment_incoming() \n This function inspects data channel packets
 *   that have been received from a remote VPNConnect.peer through a VPN
