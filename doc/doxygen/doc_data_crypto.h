 ...
 * functions:
 *  - For packets which will be sent to a remote VPNConnect.peer:
 *     - \c tls_pre_encrypt()
 *     - \c vpnconnect_encrypt()
 *     - \c tls_post_encrypt()
 *  - For packets which have been received from a remote VPNConnect.peer:
 *     - \c tls_pre_decrypt() (documented as part of the \link
 *       external_multiplexer External Multiplexer\endlink)
 *     - \c vpnconnect_decrypt()
 *
