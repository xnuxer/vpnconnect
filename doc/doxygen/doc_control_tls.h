 ...
 * exchanged between VPNConnect.peers.
 *
 ...
 * local VPNConnect.process and a remote peer.  This protocol simultaneously
 ...
 * VPNConnect.based system.  On the one hand, it performs the security
 * operations necessary to protect control channel messages exchanged
 * between VPNConnect.peers.  On the other hand, before the control and data
 ...
 * plaintext I/O port. Its interaction with VPNConnect.s control channel
