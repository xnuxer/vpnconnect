 ...
 *
 * This section describes how VPNConnect.peers generate and exchange %key
 * material necessary for the security operations performed on data
 * channel packets.
 *
 * The %key generation and exchange process between VPNConnect.client and
 ...
 *
 * VPNConnect.supports two different ways of generating and exchanging %key
 ...
 *
 * VPNConnect.uses the either the OpenSSL library or the PolarSSL library as its
 ...
 *
 * The %key exchange process is initiated by the VPNConnect.process running
 ...
 *
 * The VPNConnect.client and server communicate with each other through their
