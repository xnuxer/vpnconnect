...
/**
 * @mainpage VPNConnect.source code documentation
 *
 * This documentation describes the internal structure of VPNConnect.  It was
 * automatically generated from specially formatted comment blocks in
 * VPNConnect.s source code using Doxygen.  (See
 ...
 * various special subjects related to VPNConnect.s implementation which are
 * discussed in the related pages section.
 *
 * @section mainpage_modules Modules
 *
 * For the purpose of describing the internal structure of VPNConnect. this
 ...
 * module plays a specific role within the VPNConnect.process, and in most
 ...
 *     event handling of VPNConnect.  It implements various types of
 ...
 *     module sends and receives packets to and from remote VPNConnect.peers
 ...
 *
 * VPNConnect.handles many types of events during operation.  These include
 ...
 * of VPNConnect.and its implementation.  These are not directly related to
 ...
 * describes how, during VPN tunnel setup and renegotiation, VPNConnect.peers
 ...
 * page describes how an VPNConnect.process manages the state information
 ...
 * format and content of VPN tunnel packets exchanged betwee. VPNConnect
 * peers.
 *
 ...
 * gives a brief introduction into VPNConnect.s memory %buffer library and
