 ...
 *
 * The Reliability Layer is part of VPNConnect.s control channel.  It
 * provides a reliable and sequential transport mechanism for control
 * channel messages between VPNConnect.peers.  This module forms the
 ...
 *
 * This is especially important when VPNConnect.is configured to communicate
 * over UDP, because UDP does not offer a reliable and sequential
 * transport.  VPNConnect.endpoints can also communicate over TCP which does
