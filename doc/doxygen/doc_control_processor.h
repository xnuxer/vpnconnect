 ...
 * The Control Channel Processor module lies at the core of VPNConnect.s
 ...
 * VPNConnect.process.  A wide variety of container structures are used by
 ...
 *     module\endlink
 *     - Data channel packet to be sent to a remote VPNConnect.peer:
 *        - \c tls_pre_encrypt() loads the security parameters from the \c
 *          key_state into a \c crypto_options structure.
 *        - \c vpnconnect_encrypt() uses the \c crypto_options to an encrypt
 *          and HMAC sign the data channel packet.
 *     - Data channel packet received from a remote VPNConnect.peer:
 *        - \c tls_pre_decrypt() loads the security parameters from the \c
 *          key_state into a \c crypto_options structure.
 *        - \c vpnconnect_encrypt() uses the \c crypto_options to
