...
/**
 * @page memory_management VPNConnect.s memory management strategies
 *
 * This section describes several implementation details relating to
 * VPNConnect.s memory management strategies.
 *
 * During operation, the VPNConnect.process performs all kinds of operations
 ...
 * likelihood of memory-related bugs, VPNConnect.uses its own memory %buffer
 ...
 * structure itself.
 *
 * VPNConnect.s %buffer library, implemented in the \c buffer.h and \c
 ...
 *
 * VPNConnect.has many sizable functions which perform various actions
