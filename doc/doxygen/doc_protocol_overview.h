 ...
 *             packet compression.
 *
 *  Copyright (C) 2010-2014 Fox Crypto B.V. <vpnconnect@fox-it.com>
 *
 *
...
/**
 * @page network_protocol VPNConnect.s network protocol
 *
 * Description of packet structure in VPNConnect.s network protocol.
 *
 * This document describes the structure of packets exchanged between
 * VPNConnect.peers.  It is based on the protocol description in the \c ssl.h
 * file.
 *
 * @section network_protocol_external Outer structure of packets exchanged between VPNConnect.peers
 *
 * VPN tunnel packets are transported between VPNConnect.peers using the UDP
 ...
 *       TLS session.  VPNConnect.seamlessly renegotiates the TLS session by
 ...
 *
 * VPNConnect.uses two different forms of packet identifiers:
 ...
 *    bits for efficiency reasons since the vast majority o. VPNConnect
 ...
 * This makes it easy for VPNConnect.to throw away bogus packets quickly,
 ...
 * VPNConnect.currently implements two %key methods.  %Key method 1 directly
 ...
 * is the default for VPNConnect.2.0+.
 *
