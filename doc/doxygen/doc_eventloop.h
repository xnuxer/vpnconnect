 ...
 *
 * This main event loop module drives the packet processing of VPNConnect.
 *
 * VPNConnect.is an event driven system.  Its activities are driven by a main
 ...
 * The major types of network events that VPNConnect.processes are:
 ...
 *
 * Beside these external events, VPNConnect.also processes other types of
 ...
 *
 * Depending on the mode in which VPNConnect.is running, a different main
