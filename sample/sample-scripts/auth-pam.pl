...
# VPNConnect.PAM AUTHENTICATON
#   This script can be used to add PAM-based authentication
#   to VPNConnect.2.0.  The VPNConnect.client must provide
#   a username/password, using the --auth-user-pass directive.
#   The VPNConnect.server should specify --auth-user-pass-verify
...
#     --auth-user-pass-verify script capability in VPNConnect.
