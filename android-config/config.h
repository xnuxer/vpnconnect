...
/* Name of package */
#define PACKAGE "vpnconnect"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "vpnconnect-users@lists.sourceforge.net"

/* Define to the full name of this package. */
#define PACKAGE_NAME "VPNConnect"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "VPNConnect 2.4-icsvpnconnect"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "vpnconnect"
