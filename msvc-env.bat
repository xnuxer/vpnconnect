...
if "%VPNCONNECT_DEPROOT%" == "" set VPNCONNECT_DEPROOT=c:\Temp\vpnconnect-deps
if "%OPENSSL_HOME%" == "" set OPENSSL_HOME=%VPNCONNECT_DEPROOT%
if "%LZO_HOME%" == "" set LZO_HOME=%VPNCONNECT_DEPROOT%
if "%PKCS11H_HOME%" == "" set PKCS11H_HOME=%VPNCONNECT_DEPROOT%
if "%TAP_WINDOWS_HOME%" == "" set TAP_WINDOWS_HOME=%VPNCONNECT_DEPROOT%
